...
class AddNewFoodItemActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        currentLable.backgroundTintList = ColorStateList.valueOf(ContextCompat.getColor(this, R.color.orange))



        binding.btnLunch.setOnClickListener {
            currentLable.backgroundTintList = ColorStateList.valueOf(ContextCompat.getColor(this, R.color.white))
...
//                   var myFoodItemRef = dbFoodItemRef.setValue(foodId)
                    dbFoodItemRef.child(foodId.toString()).setValue(foodItemModel).addOnSuccessListener {
                        ...
                        .addOnFailureListener { exception ->
                            Toast.makeText(applicationContext, "Failed to save item: ${exception.message}", Toast.LENGTH_SHORT).show()
                        }
                        .addOnCompleteListener { task ->
                            if (task.isSuccessful) {
                                ...
                                Toast.makeText(applicationContext, "Something went wrong: $error", Toast.LENGTH_SHORT).show()
                            }
                        }
